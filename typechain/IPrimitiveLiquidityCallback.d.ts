...
interface IPrimitiveLiquidityCallbackInterface extends ethers.utils.Interface {
  functions: {
...
export class IPrimitiveLiquidityCallback extends Contract {
  ...
  interface: IPrimitiveLiquidityCallbackInterface;
